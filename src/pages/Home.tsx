        ...
        <div className="w-full h-screen flex overflow-hidden">
            ...
            >
                <div>
                    ...
                    <div className="px-2">
                        <Link
                            to="/settings"
                            className="flex items-center gap-2 cursor-pointer text-sm text-zinc-300 hover:bg-zinc-700 rounded-md px-2 py-1"
                        >
            ...
            >
                <div className="p-3 flex items-center gap-2">
                    ...
                    <span className="text-zinc-300">file.md</span>
                </div>
